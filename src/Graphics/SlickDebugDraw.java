...
public class SlickDebugDraw extends DebugDraw {
    ...
    public SlickDebugDraw(IViewportTransform trans)
    {
        super(trans);
    }
    Graphics g;
    ...
    public float map(float mapMe, float fromLow, float fromHigh,
    ...
    public Vec2 worldToScreen(Vec2 world) {
        ...
        if (yFlip == -1.0f)
            y = map(y, 0f, container.getHeight(),
                    container.getHeight(), 0f);
        return new Vec2(x, y);
    }
    ...
    public Vec2 screenToWorld(Vec2 screen) {
        ...
        float y = screen.y;
        if (yFlip == -1.0f)
            y = map(y, container.getHeight(), 0f, 0f, container
                    .getHeight());
    ...
    public void drawCircle(Vec2 center, float radius, Color3f color) {
        ...
        Color slickColor = new Color(color.x / 255.0f,
     ...
     */
    @Override
    public void drawPolygon(Vec2[] vertices, int vertexCount,
            Color3f color) {
